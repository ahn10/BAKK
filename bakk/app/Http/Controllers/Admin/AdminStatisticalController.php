...
class AdminStatisticalController extends Controller
{
	public function index()
    {
        ...
        $statusTransaction = [
            [
                'Completed' , $transactionSuccess, false
            ],
            [
                'Delivering' , $transactionProcess, false
            ],
            [
                'In Progress' , $transactionDefault, false
            ],
            [
                'Canceled' , $transactionCancel, false
            ]
        ];

        $listDay = Date::getListDayInMonth();

        //Profit in month in progress
        ...
        //Profit in month in progress in Delivery
