    ...
    saveComments()
    {
        $("body").on("click",".js-save-comment", function(event){
            ...
            if (typeof ROUTE_COMMENT !== "undefined")
            {
                ...
                if (!comment.length) {
                    toast.warning('Content of comment do not leave a blank!');
                    return false;
                }
                $.ajax({
                    url: ROUTE_COMMENT,
    ...
    renderFormReply(productID, commentID, name)
    {
        return `<div class="form-comment">
                    ...
                    <input type="hidden" name="commentId" value="${commentID}">
                        ...
                        <div class="footer">
                            <p>
                                <a href=""><i class="la la-camera"></i> Upload image</a>
                                <a href="">Post comment policy</a>
                            </p>
                            <button class="js-reply-comment" data-reply="">Submit</button>
                        </div>
                    </form>
                </div>`
    }
