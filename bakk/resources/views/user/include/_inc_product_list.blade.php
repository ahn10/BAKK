@foreach($products as $product)
    <div class="product-item">
        ...
        <p class="rating">
            ...
            <span class="text">{{ $product->pro_review_total }} Rate</span>
        </p>
        @if ($product->pro_sale)
            <p>
                ...
                <span class="price-sale">${{ number_format($product->pro_price,2,'.',',') }}</span>
            </p>
        @else
            <p class="price">${{  number_format($product->pro_price,2,'.',',') }}</p>
        @endif
