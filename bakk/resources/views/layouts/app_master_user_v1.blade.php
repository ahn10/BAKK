            ...
            <div class="navbar navbar-expand-lg bg-dark navbar-dark sticky-top">
                ...
                <div class="collapse navbar-collapse flex-column" id="navbar-collapse">
                    <ul class="navbar-nav d-lg-block">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{  route('get.user.update_info') }}">Update Information</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('get.user.transaction') }}">Order Management</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('get.user.favourite') }}">Wish List</a>
                        </li>
