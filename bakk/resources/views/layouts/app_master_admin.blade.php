...
<html>
    <head>
        ...
        <title>System Management Page</title>
...
{{--                            <li><a href="{{  route('admin.statistical') }}"><i class="fa fa-circle-o text-red"></i> <span>Statistics</span></a></li>--}}
{{--                        @endif--}}
                    </ul>
                </section>
                <!-- /.sidebar -->
            ...
            <footer class="main-footer">
                ...
                <strong>BAKK Gaming - 2022</strong>
            </footer>
            ...
            $(function(){
                ...
                $(".js-delete-confirm").click(function(event){
                    ...
                    $.confirm({
                        ...
                        content: 'Deleted data can not be recovered',
                        type: 'red',
                        buttons: {
                            ok: {
                                text: "ok!",
