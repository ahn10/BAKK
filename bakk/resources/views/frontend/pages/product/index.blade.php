    ...
    <div class="container">
        <div class="product-list">
            ...
            <div class="right">
                        ...
                        @for($i = 1; $i <= 6; $i++)
                            <li class="{{ Request::get('price') == $i ? "active" : "" }}">
                                <a href="{{ request()->fullUrlWithQuery(['price' =>  $i]) }}">
                                    {{  $i == 6 ? "Greater than $100" : "Price ". "$" . number_format($i * 20,2,'.',',') }}
                                </a>
                            </li>
                        @endfor
                    </ul>
                ...
                {{-- {{  dd($products) }} --}}
                <div class="order-tab">
                    <span class="total-prod">We found {{ $products->total() }} games you might like</span>
                    <div class="sort">
                        <div class="item">
                            <span class="title js-show-sort">Sort <i class="fa fa-caret-down"></i></span>
                            <ul>
                                <li><a class="{{ Request::get('sort') == 'desc' ? "active" : "" }}" href="{{ request()->fullUrlWithQuery(['sort'=> 'desc']) }}">Newest</a></li>
