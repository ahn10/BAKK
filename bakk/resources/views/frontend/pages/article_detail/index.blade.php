    ...
    <div class="container">
        <div class="breadcrumb">
            <ul>
                ...
                <li >
                    <a href="{{  route('get.blog.home') }}" title="Articles"><span itemprop="title">Articles</span></a>
                </li>
                <li >
                    <a href="javascript://" title="Articles"><span itemprop="title">{{  $article->a_name }}</span></a>
                </li>
            </ul>
        </div>
        <div class="blog-main">
