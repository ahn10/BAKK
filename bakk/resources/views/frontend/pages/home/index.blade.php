...
@section('content')
    ...
    <div class="container" id="before-slide">
        ...
        <div class="product-one">
            <div class="top">
                <a href="#" title="" class="main-title">Best Seller</a>
                {{-- <ul class="top__tab">
                    <li data-id="proNewst1" class="active"><a href="javascript://" title="">All</a></li>
...
{{--                @endfor--}}
        ...
        <div class="product-three">
            <div class="top">
                <a href="#" title="" class="main-title">NEW ARRIVALS</a>
            </div>
            <div class="bot">
                <div class="left">
                    <div class="image">
        ...
        <div class="product-two">
            <div class="top">
                <a href="#" class="main-title">Hot Games</a>
            </div>
            <div class="bot">
