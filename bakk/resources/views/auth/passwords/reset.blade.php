    ...
    <div class="container">
        <div class="breadcrumb">
            <ul>
                ...
                <li itemscope="" >
                    <a itemprop="url" href="" title="Reset Password"><span itemprop="title">Reset Password</span></a>
                </li>
        ...
        <div class="auth" style="background: white;">
            <form class="from_cart_register" action="" method="post" style="width: 500px;margin:0 auto;padding: 30px 0">
                ...
                <div class="form-group">
                    <label for="name">New Password <span class="cRed">(*)</span></label>
                ...
                <div class="form-group">
                    <label for="name">Confirm New Password <span class="cRed">(*)</span></label>
                ...
                <div class="form-group">
                    <button class="btn btn-purple btn-xs">Change Password</button>
                </div>
            </form>
        </div>
    </div>
