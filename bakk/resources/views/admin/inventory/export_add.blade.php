                    ...
                    <form role="form" action="" method="POST">
                        ...
                        <div class="col-sm-8">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" required name="w_qty"  placeholder="">
                            </div>
                        </div>
                        <div class="col-sm-8">
                            <div class="form-group">
                                <label for="name">Price <span class="text-danger">(*)</span></label>
                                <input type="number" class="form-control" required name="w_price"  placeholder="">
                            </div>
                        </div>
                        <div class="col-sm-8">
                            <div class="form-group">
                                ...
                                <select name="w_order_id" class="form-control" required id="">
                                    ...
                                    @foreach($transactions as $item)
                                        <option value="{{ $item->id }}">${{ $item->tst_email }} - {{ $item->tst_name }} - {{ number_format($item->tst_total_money,2,'.',',') }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
