                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Price</label>
                             <input type="text" name="pro_price" value="{{  $product->pro_price ?? old('pro_price',0,'.','.') }}" class="form-control" data-type="currency" placeholder="">
...
{{--                    </div>--}}
                ...
                <div class="form-group ">
                    <label class="control-label">Category <b class="col-red">(*)</b></label>
                ...
                <div class="form-group ">
                    <label class="control-label">Provider <b class="col-red">(*)</b></label>
        ...
        <div class="box box-warning">
            ...
            <div class="box-body ">
                ...
                <div class="box-footer text-center">
                    ...
                    <button type="submit" class="btn btn-success"><i class="fa fa-save"></i> {{ isset($product) ? "Update" : "Add new" }} </button> </div>
            </div>
        </div>
    </div>
</form>
